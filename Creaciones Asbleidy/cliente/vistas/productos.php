...
<body>
    ...
    <main>
        <div class="inicio">
            <h1>Productos</h1>
            <div class="botones">
                <button type="submit" onclick="location.href='crearp.html'"><i class="fa fa-plus-circle"></i>
                    Crear</button>
                <button type="submit" onclick="location.href='modificarp.html'"><i class="fa fa-pencil-square"></i>
                    Modificar</button>
            </div>
            <!-- -->
